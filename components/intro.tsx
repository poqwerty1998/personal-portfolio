...
export default function Intro() {
  return (
    <section className="mb-28 max-w-[50rem] text-center sm:mb-0">
      ...
      >
        <span className="font-bold">Hey! I'm Peter Xiao.</span> I'm a{" "}
        ...
        <span className="underline">
          exploring the world of web development with React.
        </span>
      </motion.p>
      ...
      >
        ...
        <a className="group bg-white px-7 py-3 flex items-center gap-2 rounded-full outline-none
          ...
          download>
          Download Resume <HiDownload className="opacity-60 group-hover:transition-y-1 transition"/>
        </a>

        <a className="bg-white px-4 py-3 text-gray-700 flex items-center gap-2 rounded-full focus-scale[1.15]
        hover:scale-[1.15] hover:text-gray-950 active:scale-105 transition cursor-pointer border border-black/10">
          <BsLinkedin />
        </a>

        <a className="bg-white px-4 py-3 text-gray-700 flex items-center gap-2 text-[1.35rem] focus-scale-[1.15] rounded-full
        hover:scale-[1.15] hover:text-gray-950 active:scale-105 transition cursor-pointer border border-black/10"
        href="">
          <FaGithubSquare />
        </a>
